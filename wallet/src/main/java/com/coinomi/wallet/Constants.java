...
import com.coinomi.core.coins.WorldleadcurrencyMain;
...
//        COINS_ICONS.put(CoinID.URO_MAIN.getCoinType(), R.drawable.uro);
        ...
        COINS_ICONS.put(CoinID.WORLDLEADCURRENCY_MAIN.getCoinType(), R.drawable.worldleadcurrency);
...
//        COINS_BLOCK_EXPLORERS.put(CoinID.URO_MAIN.getCoinType(), "https://chainz.cryptoid.info/uro/tx.dws?%s");
        ...
        COINS_BLOCK_EXPLORERS.put(CoinID.WORLDLEADCURRENCY_MAIN.getCoinType(), "http://104.168.151.81/tx/%s");
    }
